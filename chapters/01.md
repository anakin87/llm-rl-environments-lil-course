...
At some point, this paradigm started showing its limits: in particular, pre-training did not seem to be able to keep improving model quality
...
They used **Reinforcement Learning with Verifiable Rewards**. In this setup, the model is asked a question and generates both a reasoning trace and an answer. The answer is then checked against a known correct answer.  In this paradigm, the model is asked a question and generates both a reasoning trace and an answer. The answer is then checked against a known correct answer. The reward is used for Reinforcement Learning training.
