...
In this course, I use the term **trajectory** (or **rollout**) to mean a complete run of the agent interacting with the environment until the game ends.

![An agent interacts with the environment, trying to take smart actions to maximize cumulative rewards. From Lilian Weng's Blog](./agent_env_lilianweng.png)
...
![LLM training stages. By Maxime Labonne](./training_stages_mlabonne.png)
...
![RLVR By Sebastian Raschka](./rlvr_raschka.webp)
...
Some of these ideas may feel abstract at first, but they will become clearer once we walk through a concrete environment step by step. For more detailed information on RL concepts, check out the below Resources section.
