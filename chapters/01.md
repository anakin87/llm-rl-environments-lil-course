...
The release of [DeepSeek-R1](https://www.nature.com/articles/s41586-025-09422-z) brought renewed attention to RL in LLMs and popularized the use of **Reinforcement Learning with Verifiable Rewards** at scale. In this setup, the model is asked a question and generates both a reasoning trace and an answer. The answer is then checked against a known correct answer. While reasoning models popularized RLVR, the idea is more general: any task where the outcome can be verified automatically (a correct answer, a won game, a successful tool call) can serve as a training signal.
