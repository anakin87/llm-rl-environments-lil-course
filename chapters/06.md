...
You can easily spin one up on Prime Intellect ([documentation](https://docs.primeintellect.ai/quickstart)).
...
`seq_len` espects the token count we calculated in the [last chapter](05.md) and ensures that most of our examples are not truncated.
...
The training plots look OK. If you are curious about more details, you can explore the "SFT" run in this [Wandb project](https://wandb.ai/stefanofiorucci/LFM2-2.6B%20Tic%20Tac%20Toe/table).
