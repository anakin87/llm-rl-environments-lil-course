...
There is still significant work to do to make it an excellent player, but that is a job for Reinforcement Learning. Go to the next chapter to see it in action!
